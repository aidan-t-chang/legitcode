...
# they will use chalk[i] pieces of chalk to solve that problem. However, if the current number 
# of chalk pieces is strictly less than chalk[i], then the student number i will be asked to 
# replace the chalk.
...
class Solution:
    def chalkReplacer(self, chalk, initialChalkPieces):
