...
# You are also given a 2D integer array factory where factory[j] = [positionj, limitj] indicates that positionj is the position of the jth factory 
...
class Solution:
    def minimumTotalDistance(self, robot, factory) -> int:
        ...
        for i in range(m): dp[i][-1] = float('inf')
